...
仓库同时公开一套已经完成布线、但明确尚未投产的
[v2.0 高性能构想](hardware/rev2.0-preliminary/README.md)：16 位 40 MSPS
ADS5560、Intel MAX 10 FPGA、直接城堡孔焊接的 RP2350 后端，以及约 0.5x、
5x、25x 三档固定模拟增益。当前 r8 CAD 已通过 ERC、DRC 和独立的 489 引脚
网络审计，THS4551 前端也附有可复现的模拟仿真。

v2.0 目前还没有 FPGA 固件和实物原型，生产文件仅供评审与报价，不能视作
可直接投产的正式版本。
